/**
 * Google Play glyph, inlined as SVG (no external request, scales cleanly,
 * inherits currentColor). Monochrome so it sits correctly on brand-coloured
 * buttons rather than misusing the four-colour mark at small sizes.
 */
export default function PlayStoreIcon({ size = 20, ...rest }) {
  return (
    <svg
      viewBox="0 0 512 512"
      width={size}
